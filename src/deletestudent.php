    ...
    <?php
        ...
        if(mysqli_num_rows($result)>0){
          ...
          while($row=mysqli_fetch_assoc($result)){
            ...
            echo '<td><a onClick="javascript: return confirm(\'You are about to delete a student entry. Are you sure?\');" href="delete.php?id='.$row["id"].'" type="button"  class="btn-del" name="btn-del"><i class="far fa-trash-alt"></i>
                   </a></td>';
            //echo '<td><input type="button" onclick="ConfirmDelete()" class="btn-del" name="btn-del"><i class="far fa-trash-alt"></i></td>';
            echo "</tr>";
            ///
      }
        }else{
